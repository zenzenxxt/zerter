          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              {studentNavItems.map((item) => {
                const isActive = (pathname === item.href || (item.href === '/student/dashboard/overview' && pathname === '/student/dashboard')) || (item.href !== '/student/dashboard/overview' && pathname.startsWith(item.href) && item.href !== '/student/dashboard');
                return (
                  <Link
                    key={item.href}
                    href={item.href}
